        ...
        <div className='mr-10 px-10 pb-6 pt-12 overflow-hidden'>
          ...
          <div className='grid grid-cols-1 mb-6'>
            {data.slice(0, 1).map((item, index) => {
              ...
              return (
                <div key={index} className='flex flex-col gap-4 shadow-lg rounded-lg px-5 py-5 bg-gradient-to-b from-[#038A59] to-[#013723]'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
            {data.slice(1).map((item, index) => {
              const IconComponent = item.Icon;
              return (
                <div key={index} className='flex flex-col gap-4 shadow-lg rounded-lg px-2 py-5 bg-gradient-to-b from-[#038A59] to-[#013723]'>
                  <div className='flex gap-2 items-center'>
                    <IconComponent size={30} className='text-yellow-400' />
